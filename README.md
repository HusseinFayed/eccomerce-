...
6) Make Order: Make order by buyer cart and subtracting carts quantity from product stock quantity
7) Make a transaction from buyer deposit to seller deposit 
8) Print Recipe by buyer order
